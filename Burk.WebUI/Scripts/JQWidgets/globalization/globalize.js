    ...
    switch (culture) {
        case "ru-RU":
            localization = {
                ...
                decimalseparator: '.',
                thousandsseparator: ',',
                pagergotopagestring: "Перейти",
                pagershowrowsstring: "Показать рядки:",
                pagerrangestring: " из ",
                ...
                sortascendingstring: "Сортировка по возростанию",
                sortdescendingstring: "Сортировка по убыванию",
                sortremovestring: "Очистить сортировку",
                groupbystring: "Группировка по етой колонке",
                groupremovestring: "Удалить с группы",
                ...
                filterchoosestring: "Пожалуйста выберете:",
                filterstringcomparisonoperators: ['пустой', 'не пустой', 'содержит', 'содержит(gu)',
                   'не включены', 'не включены(gu)', 'начинается с', 'начинается с(gu)',
                   'кончается на', 'кончается на(gu)', 'равно', 'равно(gu)', 'null', 'не null'],
        ...
        case "uk-UA":
            localization = {
                ...
                percentsymbol: "%",
                currencysymbol: "€",
                currencysymbolposition: "Після",
                decimalseparator: '.',
                thousandsseparator: ',',
                pagergotopagestring: "Перейти",
                pagershowrowsstring: "Показати рядки:",
                pagerrangestring: " із ",
                pagerpreviousbuttonstring: "наступний",
                pagernextbuttonstring: "попередній",
                pagerfirstbuttonstring: "перший",
                pagerlastbuttonstring: "останній",
                groupsheaderstring: "Перетягніть стовпець і помістіть його сюди, щоб групувати по даній колонці",
                sortascendingstring: "Сортування за зростанням",
                sortdescendingstring: "Сортування за спаданням",
                sortremovestring: "Очистити сортування",
                groupbystring: "Групування по данній колонці",
                groupremovestring: "Видалити з групи",
                filterclearstring: "Очистити",
                filterstring: "Фільтр",
                filtershowrowstring: "Показать рядки, де:",
                filterorconditionstring: "або",
                filterandconditionstring: "і",
                filterselectallstring: "(Обрати все)",
                filterchoosestring: "Будь ласка оберіть:",
                filterstringcomparisonoperators: ['порожній', 'не порожній', 'містить', 'містить(gu)',
                   'не входять', 'не входять(gu)', 'починається з', 'починається з(gu)',
                   'закінчується на', 'закінчується на(gu)', 'дорівнює', 'дорівнює(gu)', 'null', 'не null'],
                filternumericcomparisonoperators: ['gleich', 'nicht gleich', 'weniger als', 'kleiner oder gleich', 'größer als', 'größer oder gleich', 'null', 'nicht null'],
                filterdatecomparisonoperators: ['gleich', 'nicht gleich', 'weniger als', 'kleiner oder gleich', 'größer als', 'größer oder gleich', 'null', 'nicht null'],
                filterbooleancomparisonoperators: ['gleich', 'nicht gleich'],
                validationstring: "Значення не дійсне",
                emptydatastring: "Дані для відображення відсутні",
                filterselectstring: "Оберіть фільтр",
                loadtext: "Завантаження...",
                clearstring: "Очищення",
